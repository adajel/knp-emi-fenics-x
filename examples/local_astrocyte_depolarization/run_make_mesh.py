...
def solve_system(config):
    ...
    neuron3 = {"name":"neuron3",
             "tag":3,
             "membrane_tags":[3],
             "ode_models":{3:mm_hh},
    }

    neuron4 = {"name":"neuron4",
             "tag":4,
             "membrane_tags":[4],
             "ode_models":{4:mm_hh},
    }
    ...
    mesh_sub_3, sub_to_parent_3, sub_vertex_to_parent_3, _, _ = scifem.extract_submesh(mesh, ct, neuron3['tag'])
    mesh_mem_3, mem_to_parent_3, mem_vertex_to_parent_3, _, _ = scifem.extract_submesh(mesh, ft, neuron3['membrane_tags'])

    mesh_sub_4, sub_to_parent_4, sub_vertex_to_parent_4, _, _ = scifem.extract_submesh(mesh, ct, neuron4['tag'])
    mesh_mem_4, mem_to_parent_4, mem_vertex_to_parent_4, _, _ = scifem.extract_submesh(mesh, ft, neuron4['membrane_tags'])
    ...
    # Set sub meshes neuron domain
    neuron3["mesh_sub"] = mesh_sub_3
    neuron3["sub_to_parent"] = sub_to_parent_3
    neuron3["sub_vertex_to_parent"] = sub_vertex_to_parent_3
    neuron3["mesh_mem"] = mesh_mem_3
    neuron3["mem_to_parent"] = mem_to_parent_3

    # Set sub meshes neuron domain
    neuron4["mesh_sub"] = mesh_sub_4
    neuron4["sub_to_parent"] = sub_to_parent_4
    neuron4["sub_vertex_to_parent"] = sub_vertex_to_parent_4
    neuron4["mesh_mem"] = mesh_mem_4
    neuron4["mem_to_parent"] = mem_to_parent_4

    subdomain_list = {ECS['tag']:ECS, neuron['tag']:neuron, glial['tag']:glial,
            neuron3['tag']:neuron3, neuron4['tag']:neuron4}
    ...
    rho = {'z':rho_z,
            ...
            3:dolfinx.fem.Constant(mesh_sub_3, rho_n),
            4:dolfinx.fem.Constant(mesh_sub_4, rho_n),
    }
    ...
    D_Na_sub = {0:dolfinx.fem.Constant(mesh_sub_0, D_Na/(lambda_e**2)),
                ...
                3:dolfinx.fem.Constant(mesh_sub_3, D_Na/(lambda_i**2)),
                4:dolfinx.fem.Constant(mesh_sub_4, D_Na/(lambda_i**2)),
    }
    D_K_sub = {0:dolfinx.fem.Constant(mesh_sub_0, D_K/(lambda_e**2)),
               ...
               3:dolfinx.fem.Constant(mesh_sub_3, D_K/(lambda_i**2)),
               4:dolfinx.fem.Constant(mesh_sub_4, D_K/(lambda_i**2)),
    }
    D_Cl_sub = {0:dolfinx.fem.Constant(mesh_sub_0, D_Cl/(lambda_e**2)),
                ...
                3:dolfinx.fem.Constant(mesh_sub_3, D_Cl/(lambda_i**2)),
                4:dolfinx.fem.Constant(mesh_sub_4, D_Cl/(lambda_i**2)),
    }
    ...
    Na_init = {0:dolfinx.fem.Constant(mesh_sub_0, Na_e_init), \
               ...
               3:dolfinx.fem.Constant(mesh_sub_3, Na_n_init),
               4:dolfinx.fem.Constant(mesh_sub_4, Na_n_init),
    }
    K_init = {0:dolfinx.fem.Constant(mesh_sub_0, K_e_init), \
              ...
              3:dolfinx.fem.Constant(mesh_sub_3, K_n_init),
              4:dolfinx.fem.Constant(mesh_sub_4, K_n_init),
    }
    Cl_init = {0:dolfinx.fem.Constant(mesh_sub_0, Cl_e_init), \
               ...
               3:dolfinx.fem.Constant(mesh_sub_3, Cl_n_init),
               4:dolfinx.fem.Constant(mesh_sub_4, Cl_n_init),
    }
    ...
    # setup membrane models for each cell
    mem_models_neuron3 = setup_membrane_model(
            stim_params, physical_parameters, neuron3['ode_models'],
            ft, phi_M_prev[neuron3['tag']].function_space, ion_list
    )

    # setup membrane models for each cell
    mem_models_neuron4 = setup_membrane_model(
            stim_params, physical_parameters, neuron4['ode_models'],
            ft, phi_M_prev[neuron4['tag']].function_space, ion_list
    )
    ...
    subdomain_list[neuron3['tag']]['mem_models'] = mem_models_neuron3
    subdomain_list[neuron4['tag']]['mem_models'] = mem_models_neuron4
    ...
    entity_maps = [sub_to_parent_0, \
                   ...
                   sub_to_parent_3, mem_to_parent_3,
                   sub_to_parent_4, mem_to_parent_4]
