...
def get_grid(finame, funame, time):
    # Read mesh from file
    filename = f"../results/make_mesh_D1/{finame}.xdmf"
...
def plot_2D(x, origin, camera_position, grid_ECS, grid_neuron, grid_glial, grid_syn_1, grid_syn_2):
    ...
    if x == 'x':
        ...
        p.screenshot(f"results/ort_D1.png", transparent_background=True)
        p.close()
    ...
    # Save the screenshot
    p.screenshot(f"results/img_{x}_D1.png", transparent_background=True)
    p.close()
    ...
    # 4. Save the screenshot
    p.screenshot(f"results/2D_mesh_roi_{x}_D1.png", transparent_background=True)
    p.close()
...
def plot_ECS(x, origin, grid_ECS, grid_neuron, grid_glial, grid_syn_1, grid_syn_2):
    ...
    # Save screenshot
    p.screenshot(f"results/mesh_ECS_D1.png", transparent_background=True)
    p.close()
...
def plot_synapse_and_astrocyte(x, origin, grid_glial, grid_syn_1, grid_syn_2):
    ...
    # Save screenshot
    p.screenshot(f"results/mesh_synapse_and_astrocyte_D1.png", transparent_background=True)
    p.close()
    ...
    # Save screenshot
    p.screenshot(f"results/mesh_roi_astrocyte_D1.png", transparent_background=True)
    p.close()
    ...
    # Save screenshot
    p.screenshot(f"results/mesh_roi_synapse_D1.png", transparent_background=True)
    p.close()
...
def plot_neurons(x, origin, grid_neuron):
    ...
    # Save screenshot
    p.screenshot(f"results/mesh_neuron_D1.png", transparent_background=True)
    p.close()
...
def plot_mesh_overview(x, origin, grid_ECS, grid_neuron, grid_glial, grid_syn_1, grid_syn_2):
    ...
    # Save screenshot
    p.screenshot(f"results/mesh_overview_D1.png", transparent_background=True)
    p.close()
