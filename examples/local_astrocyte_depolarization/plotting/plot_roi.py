...
def plot_2D_slice(x, origin, camera_position, grid_ECS, grid_neuron, \
...
def plot_ECS_width(x, origin, camera_position, grid_ECS, grid_neuron, \
                         grid_glial, grid_syn_1, grid_syn_2, grid_ECS_width):
    ...
    # Save screenshot
    p.screenshot(f"results/roi_ECS_width.png", transparent_background=True)
    p.close()

def plot_glial_width(x, origin, camera_position, grid_ECS, grid_neuron, \
...
#plot_2D_slice('x', [x_M, c, c], "yz", grid_ECS, grid_neuron, grid_glial, grid_syn_1, grid_syn_2, grid_ECS_width, grid_glial_width)
#plot_2D_slice('y', [c, y_M, c], "xz", grid_ECS, grid_neuron, grid_glial, grid_syn_1, grid_syn_2, grid_ECS_width, grid_glial_width)
#plot_2D_slice('z', [c, c, z_M], "xy", grid_ECS, grid_neuron, grid_glial, grid_syn_1, grid_syn_2, grid_ECS_width, grid_glial_width)

plot_ECS_width('z', [c, c, z_M], "xy", grid_ECS, grid_neuron, grid_glial, grid_syn_1, grid_syn_2, grid_ECS_width)
plot_glial_width('z', [c, c, z_M], "xy", grid_ECS, grid_neuron, grid_glial, grid_syn_1, grid_syn_2, grid_glial_width)
